...
public class InforActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinner = findViewById(R.id.inforSpinner);
        layout = findViewById(R.id.inforPanel);
        im = findViewById(R.id.inforMainimg);
        im.setBackgroundResource(R.drawable.default_img_border);
        maintext = findViewById(R.id.inforMaintext);
        pagetext = findViewById(R.id.inforPage);

        item = getResources().getStringArray(R.array.inforcombo);
    ...
    public void clickBeforeBtn(View v){
        if(page == 1){
    ...
    public void clickAfterBtn(View v){
        if(page == data.size()){
